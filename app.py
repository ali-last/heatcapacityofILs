...
if tab == "Manual Input":
    ...
    F2 = st.number_input('**-CH3:**', min_value=0, max_value=12, value=3)
    F3 = st.number_input('**-CH2-**', min_value=0, max_value=44, value=2)
    ...
    F9 = st.number_input('**-O-**', min_value=0, max_value=12, value=2)
    ...
    F22 = st.number_input('**-F**', min_value=0, max_value=18, value=0)
    ...
    F27 = st.number_input('**-B**', min_value=0, max_value=1, value=0)
    F28 = st.number_input('**-S-**', min_value=0, max_value=1, value=0)
    F29 = st.number_input('**-SO2**', min_value=0, max_value=2, value=1)
